        ...
        return (
            <form className="login-form" onSubmit={this.handleSubmit}>
                ...
                <div className="form-control">
                    ...
                    <input className="form-input" type="text" id="name" name="name" onChange={this.handleChange} value={this.state.name} />
                </div>
                <div className="form-control">
                    <label className="form-label" htmlFor="student">Student</label>
                    <input className="form-input" type="checkbox" onChange={this.handleChange} value={this.state.student} id="student" name="student"/>
                </div>
                <div className="form-control">
                ...
                <div className="form-control">
                    ...
                    <textarea name="about" className="form-input" onChange={this.handleChange} value={this.state.about} ></textarea>
                </div>
